...
For normal COD use, that was treated as fine in prior team guidance. For `TPM` or ranked-ban questions, I would rather have `Trix` or the team to confirm that properly first so I do not give you the wrong answer.
